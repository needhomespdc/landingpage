...
const steps = [
  {
    ...
    description:
      'Browse fractional investment opportunities and choose a property you love.',
  },
  {
    icon: RiPieChartLine,
    title: 'Choose Your Share',
    description:
      'Select the amount you want to invest. Own a share starting from as low as you want.',
  },
  {
    icon: RiFileList3Line,
    title: 'Complete Investment',
    description: 'Fund your wallet and complete your investment securely.',
  },
  {
    icon: RiHomeSmileLine,
    title: 'Earn Rental Income',
    description: 'After the holding period, earn rental income periodically.',
  },
  {
    icon: RiLineChartLine,
    title: 'Get Paid at Maturity',
    description: 'Receive your capital appreciation when the investment matures.',
  },
] as const;

export function FractionalHowItWorks() {
  return (
