...
const steps = [
  {
    ...
    description:
      'Explore verified ready homes available for outright purchase.',
  },
  {
    icon: RiHomeSmileLine,
    title: 'Select Property',
    description:
      'Choose the property that fits your goals, budget, and lifestyle.',
  },
  {
    icon: RiWallet3Line,
    title: 'Make Property Purchase',
    description:
      'Complete payment securely and lock in full ownership of your home.',
  },
  {
    icon: RiFileList3Line,
    title: 'Get Property Documents',
    description:
      'Receive your documents and take ownership on your own terms.',
  },
] as const;

export function OutrightPurchaseHowItWorks() {
  return (
      ...
      <div className="mx-auto max-w-[1200px] px-4 md:px-6 lg:px-8">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-3xl leading-tight font-bold text-[#1A1A1A] md:text-4xl">
            Simple Steps to Full Ownership
          </h2>
        </div>
