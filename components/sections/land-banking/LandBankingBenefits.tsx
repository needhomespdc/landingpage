...
const reasons = [
  { label: 'Appreciation', detail: 'Value grows as areas develop around your land' },
  { label: 'Low upkeep', detail: 'No tenants, repairs, or property management' },
  { label: 'Verified titles', detail: 'Clear documentation before you buy' },
  { label: 'Flexible exit', detail: 'Hold as long as you want, sell when ready' },
  { label: 'Accessible entry', detail: 'Often costs less than buying a built home' },
] as const;

const benefits = [
  {
    icon: RiLineChartLine,
    text: 'Build wealth patiently as land in growth corridors rises in value',
  },
  {
    icon: RiShieldCheckLine,
    text: 'Invest with confidence through verified titles and transparent deals',
  },
  {
    icon: RiTimeLine,
    text: 'Protect your money over time without the stress of managing a property',
  },
  {
    icon: RiWallet3Line,
    text: 'Start with land banking as a simpler path into real estate ownership',
  },
] as const;

export function LandBankingBenefits() {
  return (
    <section className="bg-white py-16 md:py-20">
      <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-10 px-4 md:px-6 lg:grid-cols-[1.35fr_1fr] lg:gap-14 lg:px-8">
        <div className="relative aspect-[4/3] overflow-hidden rounded-3xl sm:aspect-[5/4] lg:aspect-auto lg:min-h-[480px]">
          <Image
            src="/images/featured/greenfield-estate.jpg"
            alt="Strategic land available for land banking investment"
            fill
        ...
        <div>
          ...
          <p className="mb-8 max-w-md text-base leading-relaxed text-[#555555]">
            Land banking is simple. You buy verified land in areas set to grow,
            hold it patiently, and exit when appreciation has worked in your
            favour.
          </p>
          ...
          >
            <span className="relative z-10">Start Land Banking</span>
            <RiArrowRightLine
